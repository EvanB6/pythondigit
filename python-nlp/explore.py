...
with open("avatarSpeeches.txt", 'r', encoding='utf-8') as file:
    ...
    # You don't have to do this, but here's a little "list comprehension" to lowercase each token in the list:
    lowerCaseTokens = [w.lower() for w in textTokens]
    # What if you change this to uppercase the tokens? 
    ...
    # Here we create a text object out of any list of tokens. (this could be the orignal textTokens.)

    # This nifty syntax below is called an "f-string" and it lets you label the thing you're outputting so you know what it is:
    ...
    avatarTextObject.concordance("avatar")
    avatarTextObject.similar("fire")
    avatarTextObject.similar("water")
    avatarTextObject.concordance("war")
    print(len(text))